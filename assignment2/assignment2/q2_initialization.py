...
def xavier_weight_init():
    ...
    """
    def _xavier_initializer(shape, dtype=None, partition_info=None):
        ...
        init = np.random.uniform(-epsilon, epsilon, size=shape)
        out = tf.convert_to_tensor(init, dtype=dtype)
        ### END YOUR CODE
        return out
